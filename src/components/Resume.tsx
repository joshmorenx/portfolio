                ...
                <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', justifyItems: 'center' }}>
                    <Box className={'each-skill'}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {programmingLangs.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                    <Box className={'each-skill'}>
                        <Typography sx={{ fontSize: isDesktop ? '0.9vw' : isTablet ? '1.1vw' : '2vw', width: '100%', marginBottom: '0.5rem' }}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {frontend.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                    <Box className={'each-skill'}>
                        <Typography sx={{ fontSize: isDesktop ? '0.9vw' : isTablet ? '1.1vw' : '2vw', width: '100%', marginBottom: '0.5rem' }}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {backend.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                    <Box className={'each-skill'}>
                        <Typography sx={{ fontSize: isDesktop ? '0.9vw' : isTablet ? '1.1vw' : '2vw', width: '100%', marginBottom: '0.5rem' }}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {databases.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                    <Box className={'each-skill'}>
                        <Typography sx={{ fontSize: isDesktop ? '0.9vw' : isTablet ? '1.1vw' : '2vw', width: '100%', marginBottom: '0.5rem' }}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {dataScience.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                    <Box className={'each-skill'}>
                        <Typography sx={{ fontSize: isDesktop ? '0.9vw' : isTablet ? '1.1vw' : '2vw', width: '100%', marginBottom: '0.5rem' }}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {tools.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                    <Box className={'each-skill'}>
                        <Typography sx={{ fontSize: isDesktop ? '0.9vw' : isTablet ? '1.1vw' : '2vw', width: '100%', marginBottom: '0.5rem' }}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {testing.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                    <Box className={'each-skill'}>
                        <Typography sx={{ fontSize: isDesktop ? '0.9vw' : isTablet ? '1.1vw' : '2vw', width: '100%', marginBottom: '0.5rem' }}>
                        ...
                        <Box sx={{ display: isDesktop || isTablet ? 'grid' : 'block', gridTemplateColumns: 'repeat(3, 1fr)', width: '100%', justifyItems: 'center' }}>
                            {others.map((a) => (<Typography sx={{ fontSize: isDesktop ? '0.8vw' : isTablet ? '1vw' : '2vw', borderRadius: '0.2rem', width: '80%', mb: '0.2rem', backgroundColor: 'gray' }} >{a}</Typography>))}
                        </Box>
                    </Box>
                </Box>
            </Box>
